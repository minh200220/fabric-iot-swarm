...
ORG_1_KEYSTORE=$(ls /var/mynetwork/certs/crypto-config/peerOrganizations/org1.example.com/users/Admin\@org1.example.com/msp/keystore/)
ORG_2_KEYSTORE=$(ls /var/mynetwork/certs/crypto-config/peerOrganizations/org2.example.com/users/Admin\@org2.example.com/msp/keystore/)
